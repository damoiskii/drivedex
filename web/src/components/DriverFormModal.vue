                            ...
                            <div class="bg-white px-6 pt-6 pb-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <!-- License Number -->
                                        <div>
                                            <label for="licenseNo" class="block text-sm font-medium text-gray-700 mb-1">
                                                License Number <span class="text-red-500">*</span>
                                            </label>
                                            <input v-model="formData.licenseNo" type="text" id="licenseNo" required
                                        ...
                                        <div>
                                            ...
                                            <input v-model="formData.licenseExpiry" type="date" id="licenseExpiry"
                                                required
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" />
                                        </div>
                                    </div>

                                    <!-- Assigned Bus and Status Row -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <!-- Assigned Bus -->
                                        <div>
                                            <label for="assignedBus"
                                                class="block text-sm font-medium text-gray-700 mb-1">
                                                Assigned Bus
                                            </label>
                                            <select v-model="formData.assignedBus" id="assignedBus"
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                                    ...
                                    <!-- Generated Password (Only for new drivers) -->
                                    <div v-if="!isEditMode">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            This password will be sent to the driver's contact. They can change it after
                                            first login.
                                        </p>
                                    </div>
...
const props = defineProps({
    ...
    buses: {
        type: Array,
        default: () => ['Bus A-101', 'Bus B-202', 'Bus C-303', 'Bus D-404', 'Bus E-505']
    }
})
...
const isEditMode = computed(() => props.driver !== null)
...
const handleSubmit = () => {
    ...
    // Include password only for new drivers
    if (!isEditMode.value) {
