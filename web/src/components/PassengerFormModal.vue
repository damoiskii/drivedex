                        ...
                        <form @submit.prevent="handleSubmit">
                            <div class="bg-white px-6 pt-6 pb-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Membership and Status Row -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <!-- Membership -->
                                        <div>
                                            <label for="membership" class="block text-sm font-medium text-gray-700 mb-1">
                                                Membership Type <span class="text-red-500">*</span>
                                            </label>
                                            <select v-model="formData.membership" id="membership" required
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input v-model="formData.emergencyContactName" type="text"
                                                id="emergencyContactName" placeholder="e.g., John Doe"
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input v-model="formData.emergencyContactPhone" type="tel"
                                                id="emergencyContactPhone" placeholder="e.g., +1 (555) 987-6543"
                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" />
                                        </div>
                                    </div>

                                    <!-- Generated Password (Only for new passengers) -->
                                    <div v-if="!isEditMode">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            This password will be sent to the passenger's email. They can change it after
                                            first login.
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea v-model="formData.notes" id="notes" rows="2"
                                            placeholder="Any additional information about the passenger..."
                                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all resize-none"></textarea>
                                    </div>
                                </div>
                            </div>
...
const isEditMode = computed(() => props.passenger !== null)
...
const handleSubmit = () => {
    ...
    // Include password only for new passengers
    if (!isEditMode.value) {
...
watch(() => props.show, (newVal) => {
    if (newVal) {
        if (props.passenger) {
            // Edit mode - populate form with passenger data
            formData.value = { ...props.passenger }
        } else {
