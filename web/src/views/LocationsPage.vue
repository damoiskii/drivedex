<template>
    <div class="p-8">
        ...
        <!-- Location View Modal -->
        <LocationViewModal :show="viewModal.show" :location="viewModal.location" @close="closeViewModal"
            @edit="editFromView" />
...
import LocationViewModal from '../components/LocationViewModal.vue'
...
const viewLocation = (location) => {
    ...
    viewModal.value.location = location
}

const closeViewModal = () => {
    viewModal.value.show = false
    viewModal.value.location = null
}

const editFromView = (location) => {
    closeViewModal()
