<template>
    <div class="p-8">
        ...
        <!-- Route View Modal -->
        <RouteViewModal :show="viewModal.show" :route="viewModal.route" @close="closeViewModal" @edit="editFromView" />
...
import RouteViewModal from '../components/RouteViewModal.vue'
...
const deleteModal = ref({
    show: false,
    title: 'Delete Route',
    message: 'Are you sure you want to delete this route? This will affect all scheduled trips and assignments.',
    itemName: '',
    routeToDelete: null
})
...
const viewRoute = (route) => {
    ...
    viewModal.value.route = route
}

const closeViewModal = () => {
    viewModal.value.show = false
    viewModal.value.route = null
}

const editFromView = (route) => {
    closeViewModal()
    editRoute(route)
}
...
const deleteRoute = (route) => {
    ...
    deleteModal.value.itemName = route.name
    deleteModal.value.routeToDelete = route
}

const confirmDelete = () => {
    const route = deleteModal.value.routeToDelete
    ...
    deleteModal.value.routeToDelete = null
}
